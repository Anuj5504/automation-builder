...
import { addEdge, Background, Connection, Controls, Edge, EdgeChange, MiniMap, NodeChange, ReactFlow, ReactFlowInstance, ReactFlowProvider } from '@xyflow/react';
        ...
        <ResizablePanelGroup direction='horizontal' className="h-screen" >
            <ResizablePanel defaultSize={70}    >
                <div className="h-full w-full">
                    <div className='relative w-[94vw] h-[92vh]'>
                        <ReactFlowProvider>
                            {isWorkFlowLoading ? (
                                ...
                                >
                                    <Controls position="top-left" className='dark:text-black' />
                                    <MiniMap
